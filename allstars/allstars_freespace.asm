...
BeastOverEmotionMug:
	...
	.definelabel GREGAR_CHIP_DATA_FILE_ADDR, 0x21DA8

	.macro import_chip_icon, chip_id
	.import OTHER_VERSION_ROM, readu32(OTHER_VERSION_ROM, GREGAR_CHIP_DATA_FILE_ADDR + chip_id * 0x2c + 0x20) - 0x8000000, 0x80
	.endmacro

	.macro import_chip_image, chip_id
	.import OTHER_VERSION_ROM, readu32(OTHER_VERSION_ROM, GREGAR_CHIP_DATA_FILE_ADDR + chip_id * 0x2c + 0x24) - 0x8000000, 0x20 * 42
	.endmacro

	.macro import_chip_palette, chip_id
	.import OTHER_VERSION_ROM, readu32(OTHER_VERSION_ROM, GREGAR_CHIP_DATA_FILE_ADDR + chip_id * 0x2c + 0x28) - 0x8000000, 0x20 * 42
	.endmacro


	BASS_CHIP_ID equ 0x12d
	BIGHOOK_CHIP_ID equ 0x12e
	DELTARAY_CHIP_ID equ 0x12f
	COLFORCE_CHIP_ID equ 0x130
	BUGRSWRD_CHIP_ID equ 0x131

BassChipIcon:
	import_chip_icon BASS_CHIP_ID

BassChipImage:
	import_chip_image BASS_CHIP_ID

BassChipPalette:
	import_chip_palette BASS_CHIP_ID

BigHookChipIcon:
	import_chip_icon BIGHOOK_CHIP_ID

BigHookChipImage:
	import_chip_image BIGHOOK_CHIP_ID

BigHookChipPalette:
	import_chip_palette BIGHOOK_CHIP_ID

DeltaRayChipIcon:
	import_chip_icon DELTARAY_CHIP_ID

DeltaRayChipImage:
	import_chip_image DELTARAY_CHIP_ID

DeltaRayChipPalette:
	import_chip_palette DELTARAY_CHIP_ID

ColForceChipIcon:
	import_chip_icon COLFORCE_CHIP_ID

ColForceChipImage:
	import_chip_image COLFORCE_CHIP_ID

ColForceChipPalette:
	import_chip_palette COLFORCE_CHIP_ID

BugRSwrdChipIcon:
	import_chip_icon BUGRSWRD_CHIP_ID

BugRSwrdChipImage:
	import_chip_image BUGRSWRD_CHIP_ID

BugRSwrdChipPalette:
	import_chip_palette BUGRSWRD_CHIP_ID

	.include "cutscene.s"

	.macro import_chip_gfx_ptrs, chip_id, chip_icon_ptr, chip_image_ptr, chip_palette_ptr
	.org 0x8021da8 + chip_id * 0x2c + 0x20
	.word chip_icon_ptr
	.word chip_image_ptr
	.word chip_palette_ptr
	.endmacro

	import_chip_gfx_ptrs BASS_CHIP_ID, BassChipIcon, BassChipImage, BassChipPalette
	import_chip_gfx_ptrs BIGHOOK_CHIP_ID, BigHookChipIcon, BigHookChipImage, BigHookChipPalette
	import_chip_gfx_ptrs DELTARAY_CHIP_ID, DeltaRayChipIcon, DeltaRayChipImage, DeltaRayChipPalette
	import_chip_gfx_ptrs COLFORCE_CHIP_ID, ColForceChipIcon, ColForceChipImage, ColForceChipPalette
	import_chip_gfx_ptrs BUGRSWRD_CHIP_ID, BugRSwrdChipIcon, BugRSwrdChipImage, BugRSwrdChipPalette
